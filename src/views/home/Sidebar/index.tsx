        ...
        <>
            <div className="w-[360px] h-full flex flex-col border-r border-gray-200">
                <div className="flex items-center justify-between h-[50px] px-4 border-b border-gray-200">
                    ...
                    <i className="cursor-pointer w-9 h-9 rounded-full flex items-center justify-center text-gray-700 hover:bg-gray-100 transition-all">
            ...
            <UserOptions visible={isOpenModal} onCancel={() => setIsOpenModal(false)} />
        </>
    );
};
